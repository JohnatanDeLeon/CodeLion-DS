...
describe('Design System Main Exports', () => {
  ...
  describe('Style exports', () => {
    it('should export design tokens', () => {
      ...
      const tokenExports = Object.keys(designSystem).filter(key => 
        key.includes('color') || key.includes('spacing') || key.includes('typography') || key.includes('effect')
      );
  ...
  describe('Export completeness', () => {
    ...
    it('should not export undefined values', () => {
      ...
      const undefinedExports = exportEntries.filter(([, value]) => value === undefined);
