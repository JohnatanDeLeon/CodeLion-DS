...
describe("CSS Class Utilities", () => {
  describe("cn", () => {
    ...
    it("should handle mixed input types", () => {
      ...
      expect(result).toBe(
        "base array-class1 array-class2 object-class conditional",
      );
    });
  ...
  describe("mergeStyles", () => {
    it("should merge vanilla-extract class with Tailwind classes", () => {
      ...
      expect(result).toBe(
        "vanilla-extract-button focus:ring-2 hover:bg-blue-500",
      );
    });
    ...
    it("should handle arrays of Tailwind classes", () => {
      ...
      expect(result).toBe(
        "vanilla-extract-button focus:ring-2 focus:ring-blue-500 hover:bg-blue-600",
      );
    });
    ...
    it("should handle complex mixed scenarios", () => {
      ...
      expect(result).toBe(
        "vanilla-extract-complex base-styles array-class1 array-class2 active-styles large-styles",
      );
    });
  });
  ...
  describe("createVariants", () => {
    ...
    it("should work with complex variant structures", () => {
      ...
      expect(result).toBe(
        "card-base card-elevated card-lg card-blue shadow-xl",
      );
    });
